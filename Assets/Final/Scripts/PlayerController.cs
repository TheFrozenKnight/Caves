...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (charCont.isGrounded)
        {
            ...
            if (Input.GetButtonDown("Heal")) //heals the player
            {
    ...
    public void ApplyDMG(Vector3 dir, float force, DmgInfo dmgInfo) //Apply damage to the player
    {
        if (!hit)
        {
            hit = true;
            ...
            playerInventory.damage(dmgInfo);
